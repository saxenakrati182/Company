...
export class LoginService {
  ...
  readonly UserIds = [
    ...
    { userid: "carl@media.com", password: "123456", "username": "carl" },
    { userid: "john@media.com", password: "123456", "username": "john" },
    { userid: "mark@media.com", password: "123456", "username": "mark" },
  ]
  ...
  login(email: string, pass: string) {
    if (this.UserIds.some(x => (x.userid == email.toLowerCase() || x.username == email.toLowerCase()) && x.password == pass)) {
